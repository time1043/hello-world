...
- 一段话
  ...
  我有一个重要发现，现实中的所有东西都是可以被替代的，这看起来是一句人尽皆知的废话。

  但是，当我感知到数学上也有相关与之呼应的存在，这足够令我惊喜。在数学中，用多项式幂函数拟合任意函数的泰勒展开、用多项式三角函数拟合任意函数的傅立叶展开，都是在异曲同工地描述这样一个命题。

  并且在光怪陆离的现实世界中，一个命题加了件马甲，我们总辨认不出来了。诸如对“神课”的追捧，一门课程通过商业营销，让你有了一种观感：“不学这门课，这辈子就完了”。这是一次成功的营销，但是请相信科学的力量！先做出一个假设，他这么课确实是如有神助；然而就算错过了这门课，只要你一直在“展开”、一直不出局，你手上一直收集着“多项式”、一直收集着各种有用的信息。
...
- 编程语言
  ...
  老牌：java(爆内存 业务开发)、scala(业务计算)、kotlin(语法糖)；python(最简单 科学计算)
